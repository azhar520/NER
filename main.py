...
class Trainer(object):
    ...
    def train(self, epoch, data_loader):
        ...
        for i, data_batch in enumerate(tqdm(data_loader)):
            ...
            # bert_inputs, grid_labels, grid_mask2d, pieces2word, dist_inputs, sent_prefix, sent_postfix, sent_length = data_batch
            bert_inputs, grid_labels, grid_mask2d, pieces2word, dist_inputs, affix, sent_length = data_batch

            # outputs = model(bert_inputs, grid_mask2d, dist_inputs, pieces2word, sent_length, sent_prefix, sent_postfix)
            outputs = model(bert_inputs, grid_mask2d, dist_inputs, pieces2word, sent_length, affix)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--is_enhanced', type=int, help="1: true, 0: false")
    parser.add_argument('--use_affix', type=int, help="1: true, 0: false")
